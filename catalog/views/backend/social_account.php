...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <a href="<?=base_url('settings/social_account');?>" class="btn btn-sm btn-primary btn-flat"
        ...
        <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
					...
					// 	$param = 'publish';
					// }
					foreach(settings('social_account') as $sg): 
					?>
                    <tr>
                        <td><?=$n++.'.';?></td>
...
<div class="modal fade" id="modal_edit" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url('settings/editSocialAccount');?>" method="post" enctype="multipart/form-data">
