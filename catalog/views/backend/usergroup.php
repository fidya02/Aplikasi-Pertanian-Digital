        ...
        <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?=$n++.'.';?></td>
                        <td><input type="checkbox" class="check" name="check_id[]" value="<?=$ug['iduser_group'];?>">
                        </td>
                        <td><a href="#modal_add" data-toggle="modal" onclick="submit(<?=$ug['iduser_group'];?>)"><i
                                    class="fa fa-edit"></i></a>
                        </td>
                        <td><?=$ug['group_name'];?></td>
                        <td><?=date('Y-m-d H:i:s',$ug['create_at']);?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
