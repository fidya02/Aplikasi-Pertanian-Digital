        ...
        <div class="row">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to Catalog Website Pasar Pertanian Digital </h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    <p>"Selamat datang di portal inovatif yang menawarkan lebih dari sekadar belanja, namun sebuah pengalaman lengkap dalam dunia pertanian.
                         Kami mengundang Anda untuk menjelajahi beragam produk unggul yang memenuhi standar kualitas tertinggi, dari hasil pertanian segar dan
                          terbaik. Di sini, kami bukan hanya sekadar sebuah platform belanja, melainkan mitra dalam kesuksesan usaha pertanian Anda.
                          Temukanlah kemudahan bertransaksi yang luar biasa, dukungan pelanggan yang responsif, dan sumber daya berguna yang akan membantu Anda tumbuh 
                          dan berkembang dalam dunia pertanian."</p>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <p>Berbelanja di aplikasi ini sungguh mengubah cara saya melihat pasar pertanian. Kualitas produk yang luar biasa, proses transaksi yang mudah, dan layanan pelanggan yang ramah membuat pengalaman belanja saya lebih dari sekadar memuaskan.
                     Sungguh aplikasi yang saya rekomendasikan bagi siapa pun yang menginginkan kemudahan dan kehandalan dalam berbelanja produk pertanian.</p>
            </div>
        </div>
            ...
            <div class="col-lg-3 text-center d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services mb-md-0 mb-4">
                    ...
                    <div class="media-body">
                        ...
                        <span>On order over 75.000</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 text-center d-flex align-self-stretch ftco-animate">
