            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?=isset($publicproduct) ? 'active':'';?>"><a
                            href="<?=base_url('public/product');?>" class="nav-link">Menu Produk</a></li>
                    <li class="nav-item <?=isset($publiccategory) ? 'active':'';?>"><a
                            href="<?=base_url('public/category');?>" class="nav-link">Order</a></li>
                    <li class="nav-item <?=isset($publicabout) ? 'active':'';?>"><a
                            href="<?=base_url('public/about');?>" class="nav-link">Akun</a></li>
